        ...
        <div className="grid gap-6 lg:grid-cols-3">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <Card className="bg-card backdrop-blur-xl border-border shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-6 relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-foreground mb-1">{transportData[0].vehicle_number}</h3>
                  ...
                  <div className="space-y-4">
                    <div className="bg-muted p-3 rounded-lg border border-border">
                      ...
                      <p className="text-sm text-foreground font-medium">{transportData[0].driver_name}</p>
                    ...
                    <div className="bg-muted p-3 rounded-lg border border-border">
                      <p className="text-xs text-muted-foreground mb-1">Vehicle Capacity</p>
                      <p className="text-sm text-foreground font-medium">{transportData[0].capacity} Seats</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="h-full">
              <Card className="bg-card backdrop-blur-xl border-border shadow-xl h-full flex flex-col min-h-[400px]">
                <CardContent className="p-0 flex-1 relative overflow-hidden flex items-center justify-center bg-[#050B14]">
                  ...
                  <div className="relative z-10 text-center">
                    <div className="w-16 h-16 rounded-full bg-muted backdrop-blur border border-border flex items-center justify-center mx-auto mb-4 relative">
                      <motion.div 
                    ...
                    <p className="text-muted-foreground text-sm max-w-sm mx-auto">GPS tracking will activate automatically when the bus starts its journey for pickup or drop-off.</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
