    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Your weekly schedule for lectures and subjects.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gradient-to-br from-fuchsia-500/10 via-purple-500/5 to-orange-500/10 rounded-2xl border border-fuchsia-500/20 shadow-xl">
          ...
          <h3 className="text-lg font-bold text-foreground mb-1">No timetable published</h3>
          <p className="text-muted-foreground text-sm">Your class schedule has not been set up yet.</p>
        </div>
      ) : (
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {days.map((day, idx) => {
            ...
            return (
              ...
              >
                <Card className="bg-card backdrop-blur-xl border-border shadow-xl h-full flex flex-col hover:border-purple-500/30 transition-colors">
                  ...
                  <CardContent className="p-0 flex-1">
                    <div className="divide-y divide-border/50">
                      {daySchedule.map((period) => (
                        <div key={period.id} className="p-4 hover:bg-muted/30 transition-colors">
